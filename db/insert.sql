...
INSERT INTO protectionStatus (shortName, longName, description, maintenanceCost) VALUES
('EX', 'Исчезнувшие', 'Охранный статус, присваиваемый организму или группе организмов (таксонов), не встречавшихся как в дикой природе с момента последнего официально зарегистрированного наблюдения, так и не сохранившихся в неволе', 0),
('EW', 'Исчезнувшие в дикой природе', ' Охранный статус, присваиваемый биологическим видам или таксонам, представители которых сохранились только в неволе',1000),
('CR', 'Находящиеся на грани полного исчезновения', 'Охранный статус, который Международный Союз Охраны Природы (МСОП) присваивает биологическим видам или инфравидовым таксонам, имеющим чрезвычайно высокий риск исчезновения в дикой природе',800),
('EN', 'Вымирающие', 'Биологические виды, которые подвержены угрозе вымирания из-за своей критически малой численности либо воздействия определенных факторов окружающей среды',600),
('VU', 'Уязвимые', 'Охранный статус, присваиваемый биологическим видам, которые находятся под риском стать вымирающими',400),
('NT', 'Близкие к уязвимому положению', 'Этот статус предоставляется видам или нижним таксонам, которые могут рассматриваться как находящиеся под опасностью исчезновения в ближайшем будущем, хотя в настоящее время они не претендуют на статус уязвимых',200),
('LC', 'Вызывающие наименьшие опасения', 'Охранный статус, который Международный союз охраны природы присваивает биологическим видам или инфравидовым таксонам, не входящим в какую-либо иную категорию', 0);
...
INSERT INTO preserves (presName, presOwner, area, foundYear, address, staffQty, staffPersonCost, speciesRepresQty, annualStateBudget) VALUES
('Березинский биосферный заповедник', 'Андрей Прокошин', 85.2, 1925, 'Беларусь, на границе Витебской и Минской областей', RAND()*150, RAND()*200, RAND()*300, RAND()*1000000), 
('Полесский государственный радиационно-экологический заповедник', 'Михаил Рубащенко', 215, 1988, 'зона отчуждения Чернобыльской АЭС', RAND()*150, RAND()*200, RAND()*300, RAND()*1000000),
('Беловежская пуща', 'Управление делами Президента Республики Беларусь', 141, 1979, 'на границе Беларуси и Польши', RAND()*150, RAND()*200, RAND()*300, RAND()*1000000),
('Нарочанский', 'Василий Коржов', 87.3, 1999, 'Беларусь, на границе Минской и Витебской областей', RAND()*150, RAND()*200, RAND()*300, RAND()*1000000),
('Браславские озёра', 'Михаил Чичко', 71.5, 1995, 'Беларусь, запад Витебской области', RAND()*150, RAND()*200, RAND()*300, RAND()*1000000),
('Припятский', 'Управление делами Президента Республики Беларусь', 85.8, 1969, 'Беларусь, Гомельская область', RAND()*150, RAND()*200, RAND()*300, RAND()*1000000);
